    ...
    <div className="bg-zinc-900 min-h-screen">
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4">
          <h1 className="text-white text-3xl md:text-5xl font-bold mb-4 tracking-wide text-[#DAB674]">
            Find Your Perfect Getaway at Holidaze
          </h1>
          <p className="text-white text-lg md:text-2xl max-w-[637px] mx-auto mb-6 font-medium">
